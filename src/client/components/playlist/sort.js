...
// handle sorting of playlist itemsMap
// allow users to re-order playlist items
// show a placeholder until the server responds with an OK
export class PlaylistSortComponent extends ComponentBase {
	...
	_onAttach() {
		...
		const startDrag$ = Observable.fromEvent(this._$list, "mousedown")
			...
			// only allow dragging on the playlist images
